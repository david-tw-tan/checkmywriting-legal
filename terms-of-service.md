...
- **Account Creation**: You may create an account using email or Apple Sign-In
- **Account Security**: You are responsible for maintaining the security of your account
- **Age Requirement**: You must be at least 13 years old to use this service

## Acceptable Use

### You May:
- Use the app for educational purposes
- Upload your own writing samples for analysis
- Share feedback with family members (Family Plan users)
...
- **Refunds**: Refunds are handled according to Apple's App Store policies
- **Price Changes**: We may change subscription prices with notice

## Content and Intellectual Property

- **Your Content**: You retain ownership of your writing samples
- **Our Content**: The app, features, and AI analysis belong to us
...
We may terminate or suspend your account if you violate these terms. You may terminate your account at any time.

## Changes to Terms

We may update these terms. Continued use of the app constitutes acceptance of changes.
